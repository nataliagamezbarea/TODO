...
`comunes/navbar/navbar-general.html` es la navbar general. La aplicación principal la usa directamente y `visor-admin` la reutiliza dentro de `visor-navbar`, añadiendo sus botones y controles específicos del visor.
