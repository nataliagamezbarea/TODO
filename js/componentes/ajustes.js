window.Ajustes = (() => {
  ...
  const notificarCambio = (tipo = "") => {
    try {
      ...
      if (typeof window.__pintarAccionesRamas === "function") {
        window.__pintarAccionesRamas();
      }
      // Botones contextuales del Visor Admin en páginas de asignatura/tarea.
      if (typeof window.__pintarVisorAsignatura === "function") {
        window.__pintarVisorAsignatura();
      }
      if (typeof window.__pintarVisorTarea === "function") {
        window.__pintarVisorTarea();
      }
    } catch (e) {}
  };
      ...
      if (estaCargando) {
        ...
        panel.innerHTML = `
          ...
          <div class="cuerpo-ajustes">
            ...
            ${panelToogleHTML("ajuste-visor-en-grados", leer("visor_en_grados", CLAVE_VISOR_GRADOS, true), "Mostrar en grados", "fa-graduation-cap")}
