...
window.__configurarPdfWorker = function configurarPdfWorker() {
  ...
  window.pdfjsLib.GlobalWorkerOptions.workerSrc = new URL('/visor-administradoristradoristrador/bibliotecas/pdf.worker.min.js', window.location.origin).toString();
