...
window.RamaActual = window.RamaActual || (() => {
  ...
  return { obtener, guardar, limpiar, pintarSeleccionActual, poblarSelector, listarRamas: () => window.RamaAPI?.listarRamas?.() || Promise.resolve([]), obtenerRamaActual: obtener, guardarRamaActual: guardar, limpiarRamaActual: limpiar, pintarRamaSeleccionada: pintarSeleccionActual, cargarSelectorRamas: poblarSelector };
})();
