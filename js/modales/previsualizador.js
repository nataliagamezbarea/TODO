...
async function abrirArchivo(url, nombre) {
  ...
  // Los archivos normales se abren directamente; el visor DSD se abre mediante
  // los botones de gestión de la plataforma o mediante modulos/visor.html.
  ...
  try {
    const res = await fetchArchivoDesdeGitHub(url);
